...
void Pipeline::CreateGraphicsPipeline(SwapChain* swapChain, RenderPass* renderPass, Descriptor* descriptor)
{
    ...
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE; // 3D için güncelle
    ...
    pipelineInfo.pDepthStencilState = &depthStencil; // Depth testing ekle
