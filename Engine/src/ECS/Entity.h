...
public:
	...
	Entity(const uint32_t& uuid, const std::string& name);
	...
	// Editor Only
	uint32_t GetIdForMousePicking() const { return m_IdForMousePick; }
	void SetIdForMousePicking(uint32_t value ) { m_IdForMousePick = value; }
